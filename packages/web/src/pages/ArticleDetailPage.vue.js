...
if (__VLS_ctx.store.loading && !__VLS_ctx.article) {
    ...
    if (__VLS_ctx.tab === 'content') {
        ...
        __VLS_asFunctionalDirective(__VLS_directives.vHtml)(null, { ...__VLS_directiveBindingRestFields, value: (__VLS_ctx.article.content ?? __VLS_ctx.article.description ?? __VLS_ctx.article.body ?? 'No content available.') }, null, null);
    }
