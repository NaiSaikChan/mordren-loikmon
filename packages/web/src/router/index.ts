...
export const routes: RouteRecordRaw[] = [
  ...
  // ─── Main app shell ────────────────────────────────────────────────
  {
    ...
    children: [
      { path: '',           name: 'home',              component: () => import('@/pages/HomePage.vue'), meta: { footer: true } },
      { path: 'books',      name: 'books',             component: () => import('@/pages/BooksPage.vue'), meta: { footer: true } },
      ...
      { path: 'articles',   name: 'articles',          component: () => import('@/pages/ArticlesPage.vue'), meta: { footer: true } },
      { path: 'articles/:id', name: 'article-detail',  component: () => import('@/pages/ArticleDetailPage.vue'), props: true },
      { path: 'authors',    name: 'authors',           component: () => import('@/pages/AuthorsPage.vue'), meta: { footer: true } },
      ...
      { path: 'library',    name: 'library',           component: () => import('@/pages/LibraryPage.vue'), meta: { requiresAuth: true, footer: true } },
      { path: 'subscription', name: 'subscription',    component: () => import('@/pages/SubscriptionPage.vue'), meta: { footer: true } },
      ...
      { path: 'collections', name: 'collections',      component: () => import('@/pages/CollectionsPage.vue'), meta: { footer: true } },
      ...
      { path: 'policies/:slug', name: 'policy',        component: () => import('@/pages/PolicyPage.vue'), props: true },
    ],
  },
