...
export const CMS_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'cms-categories', label: 'Categories', icon: '🏷️', permissions: ['categories.view'] },
      { name: 'cms-collections', label: 'Collections', icon: '🗂️', permissions: ['collections.view'] },
    ],
  },
  {
    key: 'commerce',
    ...
    items: [
      ...
      { name: 'cms-coupons', label: 'Coupons', icon: '🎟️', permissions: ['coupons.view', 'author.coupons.analytics'] },
    ],
  },
  {
    key: 'community',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'cms-roles', label: 'Roles & permissions', icon: '🛡️', permissions: ['roles.manage'] },
